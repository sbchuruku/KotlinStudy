 ...
 */
 ...
 abstract class Person096 // 추상클래스 선언
{
    abstract fun getSalary(): Int // 추상 맴버 함수
}
...
class Employee(private val initial: Int, private val years: Int): Person096()
{
    override fun getSalary() = initial * (1.0 + years / 10.0).toInt()
}

// 구성원으로부터 학교의 재정을 구한다.
fun getFinance(vararg persons: Person096): Int
{
    var i = 0
    var finance = 0
